...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('IV_project/src',
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        while position_check:
            goal_x_list = [0.5,-0.5,-1,0.5,1.35,1.8,2.4,3,3.3,4.2,5.5,5.5,6.2,6.85,6.85,6.4,4.9,8.43,8.3,8.3,4.9,5.9,6.7]
            goal_y_list = [1,0,0,1.8,1.8,1.8,1.85,1.8,1.8,1.7,1.8,1,0.65,2.3,3.4,4.6,4.9,4.67,2.2,0.74,-0.57,-1.4,1.15]
